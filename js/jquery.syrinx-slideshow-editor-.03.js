        ...
        _setupFilmStripCell: function($editSlides) {
            ...
            $editSlides.bind("drop", function (event, ui) {
                if (event.originalEvent.dataTransfer) {
                    ...
                    $w(filmCell).data("imageUrl", fileName)
                        .find("img").attr("src", fileName).css({ width: "", height: "" }).imagesLoaded(function () {
                            self._setupFilmstripImgSizes();
                            self._updateSlideShow();
                        });
                    $w("#imageUrl").val(fileName);
                }
            }).draggable({
                distance: 10,
                    ...
                    "<div class='slide-details-core'>" +
                        ...
                        "<div class='ksg-slide-details'>" +
                            "<fieldset id='slideDetails'><legend>Slide Details</legend>" +
                                ...
                                "<br style='clear:both' />" +
                                "<div class='slide-img-url'>Image Url:<input type='text' id='imageUrl' style='width:80%'></input></div>" +
                            "</fieldset>" +
                        "</div>" +
